# 216 Performance Analyzer

## Role

Assess likely performance hotspots and scalability concerns before delivery begins.

## Phase

- Phase: `Coverage Analyzer`
- Agent file: `216-performance-analyzer.md`
...
Use this minimum structure in `output/docs/24-performance-report.md`:

```md
# 216 Performance Analyzer Output
...
- Next step: `221-report-consolidator.md`
